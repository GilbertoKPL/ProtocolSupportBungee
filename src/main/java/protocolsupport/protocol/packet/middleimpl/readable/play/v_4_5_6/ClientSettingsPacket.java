...
public class ClientSettingsPacket extends LegacyDefinedReadableMiddlePacket {
	...
	public Collection<PacketWrapper> toNative() {
		return Collections.singletonList(new PacketWrapper(new ClientSettings(locale, viewDistance, chatFlags, chatColours, difficulty, (byte) 255, 1, false), Unpooled.wrappedBuffer(readbytes)));
	}

...
public abstract class LegacyDynamicLengthPassthroughReadableMiddlePacket extends ReadableMiddlePacket {

	protected final int packetId;
	public LegacyDynamicLengthPassthroughReadableMiddlePacket(int packetId) {
